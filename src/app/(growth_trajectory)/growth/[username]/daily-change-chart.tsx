...
const data = [
  { date: "09/23", followers: 80 },
  { date: "09/24", followers: 85.78 },
  { date: "09/25", followers: 91.94 },
  { date: "09/26", followers: 96.2 },
  { date: "09/27", followers: 98.1 },
  { date: "09/28", followers: 100.06 },
  { date: "09/29", followers: 105.58 },
  { date: "09/30", followers: 115.56 },
  { date: "10/01", followers: 126.68 },
  { date: "10/02", followers: 133.52 },
  { date: "10/03", followers: 133.28 },
  { date: "10/04", followers: 129.02 },
  { date: "10/05", followers: 128.04 },
  { date: "10/06", followers: 136.16 },
  { date: "10/07", followers: 152.24 },
  { date: "10/08", followers: 168.16 },
  { date: "10/09", followers: 174.68 },
  { date: "10/10", followers: 169.26 },
  { date: "10/11", followers: 159.02 },
  { date: "10/12", followers: 156 },
  { date: "10/13", followers: 167.62 },
  ...
  return (
    <Card className="divide-y border mb-6 md:mb-8 divide-gray-200 overflow-hidden border-gray-100 bg-white col-span-2 pb-0">
      <CardContent className="p-6">
        <div className="block w-full px-3 pt-3 pb-0 mb-5 sm:flex sm:px-3">
          <div className="w-full">
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <p className="inline-flex items-center mb-1 text-xl font-bold tracking-tight text-gray-800 font-dashboard">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="mr-3 w-7 h-7 text-sky-500">
                      <path fill="currentColor" fillRule="evenodd" d="M22 10c0-2.8 0-4.2-.545-5.27a5 5 0 0 0-2.185-2.185C18.2 2 16.8 2 14 2h-4c-2.8 0-4.2 0-5.27.545A5 5 0 0 0 2.545 4.73C2 5.8 2 7.2 2 10v4c0 2.8 0 4.2.545 5.27a5 5 0 0 0 2.185 2.185C5.8 22 7.2 22 10 22h4c2.8 0 4.2 0 5.27-.545a5 5 0 0 0 2.185-2.185C22 18.2 22 16.8 22 14zm-11.711 5c-1.68 0-2.52 0-2.935-.34a1.5 1.5 0 0 1-.548-1.208c.018-.536.57-1.168 1.677-2.432l1.71-1.956c.624-.712.936-1.069 1.306-1.2a1.5 1.5 0 0 1 1.002 0c.37.131.682.488 1.305 1.2l1.711 1.956c1.106 1.264 1.66 1.896 1.677 2.432a1.5 1.5 0 0 1-.549 1.208c-.414.34-1.254.34-2.934.34z" clipRule="evenodd" opacity="0.12"></path>
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M2 10c0-2.8 0-4.2.545-5.27A5 5 0 0 1 4.73 2.545C5.8 2 7.2 2 10 2h4c2.8 0 4.2 0 5.27.545a5 5 0 0 1 2.185 2.185C22 5.8 22 7.2 22 10v4c0 2.8 0 4.2-.545 5.27a5 5 0 0 1-2.185 2.185C18.2 22 16.8 22 14 22h-4c-2.8 0-4.2 0-5.27-.545a5 5 0 0 1-2.185-2.185C2 18.2 2 16.8 2 14z"></path>
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M13.806 9.064c-.623-.712-.935-1.069-1.305-1.2a1.5 1.5 0 0 0-1.002 0c-.37.131-.682.488-1.305 1.2L8.483 11.02c-1.106 1.264-1.66 1.896-1.677 2.432a1.5 1.5 0 0 0 .548 1.208C7.77 15 8.61 15 10.29 15h3.422c1.68 0 2.52 0 2.934-.34a1.5 1.5 0 0 0 .549-1.208c-.017-.536-.57-1.168-1.677-2.432z"></path>
                    </svg>
                    Daily Change
                ...
                <TooltipContent>
                  <div>Shows the change in followers and following of the account compared to <b>the previous day</b>. 
                  <br /><i style={{opacity:0.9}}>The start date of this chart changes according to the first time the profile was added on UpGrow.</i></div>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
            <p className="text-2xl font-bold text-gray-900 whitespace-nowrap">
              <span className="inline-flex items-center font-dashboard">45,822,765</span>
              <div className="align-middle ml-4 inline-flex items-center rounded-full bg-green-100 px-2.5 py-0.5 text-sm font-medium text-green-600">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon" className="-ml-1 mr-0.5 h-5 w-5 flex-shrink-0 self-center text-green-500">
                  <path fillRule="evenodd" d="M10 15a.75.75 0 0 1-.75-.75V7.612L7.29 9.77a.75.75 0 0 1-1.08-1.04l3.25-3.5a.75.75 0 0 1 1.08 0l3.25 3.5a.75.75 0 1 1-1.08 1.04l-1.96-2.158v6.638A.75.75 0 0 1 10 15Z" clipRule="evenodd"></path>
                </svg>
                -0.36%
              </div>
            </p>
            ...
            <div className="relative inline-flex items-center justify-start w-full pr-1 mt-3 sm:justify-end sm:mt-0">
              <div className="mx-auto flex flex-col items-center -ml-4 sm:-ml-6 lg:ml-0 lg:mr-0 overflow-scroll lg:w-auto w-[calc(100%_+_32px)] lg:overflow-hidden px-4 lg:px-0">
                <div className="relative inline-flex self-start justify-start w-auto p-1 rounded-lg tremor-TabGroup-root flex-nowrap sm:self-end bg-[#F3F4F6] backdrop-blur-sm">
                  <span className="absolute top-0 bottom-0 flex py-1 transition-all duration-300 rounded-lg -z-10" style={{left: activeTab === "All Time" ? "4px" : activeTab === "30 Days" ? "90px" : "176px", width: "86px"}}>
                    <span className="w-full h-full overflow-visible bg-white rounded shadow"></span>
                  </span>
                  {["All Time", "30 Days", "Daily"].map((tab) => (
                    <button
                      key={tab}
                      className={`font-medium my-auto cursor-pointer select-none rounded whitespace-nowrap text-sm text-center py-1.5 flex items-center justify-center px-4 ${
                        activeTab === tab ? "text-zinc-900" : "group hover:text-neutral-500 text-neutral-400"
                      }`}
        ...
        <div id="daily-change-chart" className="bg-white -ml-[20px] w-[calc(100%_+_40px)] mb-2.5">
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              <defs>
                <linearGradient id="gradient-blue-dim" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="20%" stopColor="#199af5" stopOpacity="1" style={{ filter: 'saturate(1.4)' }} />
                  <stop offset="100%" stopColor="#199af5" stopOpacity="0.9" style={{ filter: 'saturate(1.4)' }} />
                </linearGradient>
              ...
              <CartesianGrid strokeDasharray="6 6" stroke="var(--color-gray-200)" vertical={false} />
              <XAxis
                dataKey="date"
