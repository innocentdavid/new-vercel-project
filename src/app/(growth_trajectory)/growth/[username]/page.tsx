...
export default async function GrowthPage({
  ...
  if (data && data.length > 0) {
    ...
    faqs = JSON.parse(Faqs).faq;
    await supabase.from("faqs").insert({ username, faqs });
  }
  ...
  return (
    <div className="bg-white_">
      <InstagramDashboard user={userProfile} Faqs={faqs} />
